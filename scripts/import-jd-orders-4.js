#!/usr/bin/env node
/**
 * Import JD To-Do list #4 — Waaree 585 (580w/680w) and DMEGC 460 (405w/460w) panels.
 * Usage:
 *   node scripts/import-jd-orders-4.js           # dry-run
 *   node scripts/import-jd-orders-4.js --apply   # insert
 */
...
//          'dmegc'  = DMEGC 460 Watt Bifacial   (405w / 460w / sunplus)
...
const ROWS = [
  { name: 'Ronnie JD',         qty: 10, product: 'waaree', locationHint: 'Anchorage, AK',                phone: '+1 (907) 312-6582', notes: '10 panels 680w' },
  { name: 'JoJo JD',           qty:  4, product: 'waaree', locationHint: 'Matanuska-Susitna Valley, AK', phone: '',                  notes: '4 panels 680w; number inquiry' },
  { name: 'Greg JD',           qty:  2, product: 'waaree', locationHint: 'Matanuska-Susitna Valley, AK', phone: '907-440-8686',      notes: '2 panels 680w CS' },
  { name: 'Andy JD',           qty:  3, product: 'waaree', locationHint: 'Fairbanks, AK',                phone: '',                  notes: '3 panels 680w; contacted via messenger' },
  { name: 'Andy JD',           qty: 25, product: 'waaree', locationHint: 'Homer, AK',                    phone: '907-202-2238',      notes: '25 panels; native guy referral' },
  { name: 'Bill Merchant JD',  qty:  3, product: 'waaree', locationHint: 'Matanuska-Susitna Valley, AK', phone: '907-304-1387',      notes: '3 panels; Mat Su' },
  { name: 'Liam JD',           qty:  4, product: 'dmegc',  locationHint: 'Soldotna, AK',                 phone: '+1 (952) 607-5199', notes: '4 panels 460w sunplus; ANC pickup' },
  { name: 'Andy JD',           qty:  6, product: 'waaree', locationHint: 'Fairbanks, AK',                phone: '+1 (907) 322-0838', notes: '6 panels 680w' },
  { name: 'David JD',          qty: 10, product: 'waaree', locationHint: 'Fairbanks, AK',                phone: '907-750-1842',      notes: '10 panels 680w; Canadian Solar' },
  { name: 'Ken JD',            qty:  2, product: 'waaree', locationHint: '',                              phone: '+1 (907) 317-2624', notes: '2 panels 580w Waaree' },
  { name: 'Michael JD',        qty:  6, product: 'waaree', locationHint: 'Coalville, UT',                phone: '',                  notes: '6 Waaree panels' },
  { name: 'Mark JD',           qty:  1, product: 'waaree', locationHint: '',                              phone: '383-320-2939',      notes: 'Wants solar panels' },
  { name: 'Skye JD',           qty: 36, product: 'waaree', locationHint: '',                              phone: '',                  notes: 'meet at Warehouse' },
  { name: 'Oscar JD',          qty: 18, product: 'dmegc',  locationHint: '',                              phone: '',                  notes: '18 DMEGC 460w panels (originally listed as 36 SunPlus 405w + 18 microinverters + 18 trunk cables $7560)' },
];
...
function printPlan(plans, products) {
  console.log('');
  console.log('=== IMPORT PLAN (JD list #4) ===');
