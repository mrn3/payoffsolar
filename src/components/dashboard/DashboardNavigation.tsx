...
import {FaTachometerAlt, FaShoppingCart, FaUsers, FaBoxes, FaWarehouse, FaBuilding, FaSun, FaUser, FaSignOutAlt, FaBars, FaTimes, FaEdit, FaTags, FaLayerGroup, FaTasks, FaGlobe, FaCog} from 'react-icons/fa';
