...
export default function DeleteAllContactsModal({ 
  ...
  const isConfirmValid = confirmText === 'DELETE ALL CONTACTS';
              ...
              <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                ...
                <div className="mt-2">
                  <p className="text-sm text-gray-500 mb-4">
                    This will permanently delete <strong>all {contactCount} contacts</strong> and 
                    <strong> all associated orders</strong>. This action cannot be undone.
                  </p>
                  <p className="text-sm text-gray-700 mb-3">
                    To confirm, type <strong>DELETE ALL CONTACTS</strong> in the field below:
                  </p>
                  <input
                    type="text"
                    value={confirmText}
