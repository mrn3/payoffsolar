...
export default function EditAffiliateCodePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setLoading(true);
      const response = await fetch(`/api/affiliate/${params.id}`, {
        method: 'PUT',
        headers: {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Edit Affiliate Code</h1>
          <p className="text-gray-600">Update the affiliate code settings</p>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-end space-x-4">
            ...
            >
              ...
              <span>{loading ? 'Updating...' : 'Update Affiliate Code'}</span>
            </button>
          </div>
        </form>
      </div>
