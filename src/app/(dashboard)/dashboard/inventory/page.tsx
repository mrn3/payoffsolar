      ...
      <div className="mt-6 flex flex-col sm:flex-row">
        <div className="sm:w-64">
          ...
          >
            ...
            <option>West Coast Warehouse</option>
          </select>
        </div>
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            ...
            <div className="mt-2 text-sm text-yellow-700">
              <p>
                3 products are below their minimum stock level. <a href="#" className="font-medium underline text-yellow-700 hover:text-yellow-600">View all alerts</a>
              </p>
            </div>
          </div>
        </div>
