	...
	try {
	  ...
	  switch (timePeriod) {
	    case 'year': {
	      ...
	      orderCounts = await OrderModel.getOrderCountsByStatusAndYear(years);
	      break;
	    }
	    ...
	    case 'month': {
	      ...
	      orderCounts = await OrderModel.getOrderCountsByStatusAndMonth(months);
	      break;
	    }
	    ...
	    case 'week': {
	      ...
	      orderCounts = await OrderModel.getOrderCountsByStatusAndWeek(weeks);
	      break;
	    }
	    ...
	    case 'day': {
	      ...
	      orderCounts = await OrderModel.getOrderCountsByStatusAndDay(days);
	      break;
	    }
