...
export async function GET(request: NextRequest) {
  try {
    ...
    if (!timePeriod || !period || !category) {
      return NextResponse.json({ error: 'timePeriod, period, and category parameters are required' }, { status: 400 });
    }
    ...
    switch (timePeriod) {
      case 'year':
        ...
        orders = await OrderModel.getOrdersByYearAndCategory(period, category);
        break;
      ...
      case 'month':
        ...
        orders = await OrderModel.getOrdersByMonthAndCategory(period, category);
        break;
      ...
      case 'week':
        ...
        orders = await OrderModel.getOrdersByWeekAndCategory(period, category);
        break;
      ...
      case 'day':
        ...
        orders = await OrderModel.getOrdersByDayAndCategory(period, category);
        break;
    ...
    console.error('Error fetching orders by period and category:', error);
